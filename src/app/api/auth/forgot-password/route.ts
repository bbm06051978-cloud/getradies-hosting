...
export async function POST(req: NextRequest) {
  try {
    ...
    if (!resendRes.ok) {
      return NextResponse.json({ error: "Email failed", details: resendData }, { status: 500 });
    }
