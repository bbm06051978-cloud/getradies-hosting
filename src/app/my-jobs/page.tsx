                            ...
                            <div className="flex flex-wrap gap-2 pt-1">
                              ...
                              {booking && (
                                <Link href={`/bookings?bookingId=${booking.id}`}>
                                  <button className="flex items-center gap-1 bg-orange-500 hover:bg-orange-600 text-white text-xs font-bold px-4 py-2 rounded-xl transition-colors">
                                    Manage Booking <ChevronRight size={12}/>
                                  </button>
                                </Link>
                              )}
