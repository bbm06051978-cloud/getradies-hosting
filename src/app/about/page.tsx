        ...
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <div className="flex flex-col gap-5">
            {[
              ...
              { name: "Bibhu", role: "Lead of Onboarding", bio: "A graduate in Hotel Management from Switzerland with extensive experience in the hospitality industry. Bibhu brings exceptional people skills and sharp negotiation expertise to ensure every tradie and homeowner joins GeTradie with confidence and ease.", initial: "B", color: "#3B82F6", photo: null, reverse: true },
              { name: "Simi", role: "Lead of Marketing & Campaigns", bio: "A dynamic force in marketing with extensive experience in event campaigns and brand management. Simi drives GeTradie's growth strategy with creativity, energy and a proven track record of making brands come alive.", initial: "S", color: "#F97316", photo: null, reverse: false },
              { name: "Shruti", role: "Customer Communication Lead", bio: "A certified yoga teacher and seasoned customer communication professional with experience across India, Dubai and Australia. Shruti brings calm, clarity and warmth to every customer interaction - ensuring GeTradie users always feel heard.", initial: "S", color: "#A855F7", photo: null, reverse: true },
              { name: "Sathish", role: "Quality & Test Lead", bio: "Meticulous, methodical and deeply experienced, Sathish leads quality and testing at GeTradie with a sharp eye for detail. Our users never see a bug - because Sathish found it first.", initial: "S", color: "#10B981", photo: null, reverse: false },
              { name: "Bidhu", role: "The One Who Started It All", bio: "The mind and heart behind GeTradie. Bidhu saw firsthand how broken the tradie marketplace was for everyday Australians and set out to fix it. With over 20 years of experience across technology, cloud infrastructure and solution consulting, Bidhu built GeTradie from the ground up - combining AI innovation with a deep understanding of what Australian homeowners and tradies actually need.", initial: "B", color: "#0047AB", photo: "/imports/Bidhu Bhusan.jpg", reverse: true },
            ].map((member, i) => (
              <div key={i} className={`flex ${member.reverse ? "flex-row-reverse" : "flex-row"} items-center gap-6`}>
